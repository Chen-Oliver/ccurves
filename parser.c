	...
	tmp = make_rotZ( theta );
      ...
      *strchr(line, '\n') = 0;
      ...
      save_extension(s, line);
        ...
        double r;
        fgets(line, sizeof(line), f);
        sscanf(line, "%lf %lf %lf %lf",xvals,yvals,zvals,&r);//cx,cy,cz,r
        add_circle(edges,xvals[0],yvals[0],zvals[0],r,.01);

    }
    else if ( strncmp(line, "hermite", strlen(line)) == 0 ) {
        fgets(line, sizeof(line), f);
        sscanf(line, "%lf %lf %lf %lf %lf %lf %lf %lf",xvals,yvals,xvals+1,yvals+1,xvals+2,yvals+2,xvals+3,yvals+3);
        add_curve(edges,xvals[0],yvals[0],xvals[1],yvals[1],xvals[2],yvals[2],xvals[3],yvals[3],0.0001,HERMITE);
    }
    else if ( strncmp(line, "bezier", strlen(line)) == 0 ) {
        fgets(line, sizeof(line), f);
        sscanf(line, "%lf %lf %lf %lf %lf %lf %lf %lf",xvals,yvals,xvals+1,yvals+1,xvals+2,yvals+2,xvals+3,yvals+3);
        add_curve(edges,xvals[0],yvals[0],xvals[1],yvals[1],xvals[2],yvals[2],xvals[3],yvals[3],0.0001,BEZIER);
    }
    else if ( strncmp(line, "color", strlen(line)) == 0 ){ //change colors(r,g,b)
      fgets(line, sizeof(line), f);
      int r,g,b;
